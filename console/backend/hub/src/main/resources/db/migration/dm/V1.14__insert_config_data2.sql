...
',1,NULL,'2000-01-01 00:00:00','2025-07-23 14:31:33'),
	 (1293,'TEMPLATE','next-question-advice','1','You now need to generate three possible follow-up questions that a user might ask based on the given question. The response format should be a JSONB array. Below are some example questions and answers:
...
"""',1,NULL,'2000-01-01 00:00:00','2025-07-23 14:33:24'),
	 (1313,'PROMPT','bot-name-desc','','You are a name and description generation assistant. You will receive a user-provided description of an assistant. Based on this information, you need to generate an appropriate name and role description for the assistant. The output format should be a standard JSONB structure:
{
...
Generate the opening line based on the input description:',1,NULL,'2000-01-01 00:00:00','2025-07-23 14:52:11'),
    ...
    {
        "label": "End",
        "description": "The end node of the workflow, used to output the final result workflow execution.",
        "nodeMeta":
        {
            "nodeType": "基础节点",
            "aliasName": "结束节点"
...
4. Add comments to describe the function''s purpose and parameter definitions. Only provide the code.
...
4. Add comments statements describing the function purpose and parameter definitions. Please provide the code directly.
...
### Constraints
Do not include anything other than the JSONB array in your response.
...
- Follow the "Output Format" structure strictly, and ensure the "Output Example" is in valid JSONB format with score and reason fields.',1,'','2025-07-31 10:52:49','2025-07-31 15:08:34'),
...
Format: Strictly output in JSONB format, with "Score" for the rating and "Reason" for the explanation.
