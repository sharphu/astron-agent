...
INSERT INTO prompt_template_en (id,uid,name,description,deleted,prompt,created_time,updated_time,node_category,adaptation_model,max_loop_count) VALUES
  ...
  "userQuery": "{{story}}"
	 ...
	 (7,-1,'Defect Analysis','You are a line chart drawing expert. Based on the input JSONB list of issues, you need to generate a line chart showing the trend of online issue closures.',0,'{
  "characterSettings": "",
  "thinkStep": "You are a line chart drawing expert. Based on the input JSONB list of issues, you need to generate a line chart showing the trend of online issue closures. The chart should cover the period from the current date to six days prior, including the following daily metrics: total number of online issues (cumulative up to the day), number of closed issues (cumulative up to the day), number of unresolved issues (total issues up to the day minus closed issues up to the day), and number of pending fix issues (cumulative pending fix issues up to the day).",
  "userQuery": "{{data_json}}"
